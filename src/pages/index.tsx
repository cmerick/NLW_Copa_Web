      ...
      <main>
        ...
        <div className="mt-10 flex items-center gap-2">
          ...
          <strong className="text-gray-100 text-xl" >
            <span className="text-specialGreen-500">+{props.userCount}</span> pessoas já estão usando
          </strong>
        </div>
        ...
        <form onSubmit={createPool} className="mt-10 flex gap-2">
          ...
          <button
            className="px-6 py-4 rounded bg-specialYellow-500 text-gray-900 font-bold text-sm uppercase hover:bg-specialYellow-700"
            type="submit"
          >
            Criar meu bolão
          </button>
        ...
        <div className="mt-10 pt-10 border-t border-gray-600 items-center flex justify-between text-gray-100">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex flex-col">
              ...
              <span className="pt-1">Bolões criados</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex flex-col">
              ...
              <span className="pt-1">Palpites enviados</span>
            </div>
          </div>
